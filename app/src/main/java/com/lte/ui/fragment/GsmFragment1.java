...
public class GsmFragment1 extends SupportFragment implements View.OnClickListener {
...
//    private MaterialSpinner spinner_gsm_bts1_workmode;
    private TextView spinner_gsm_bts2_workmode;
...
//    protected List<String> mGSMMncList1 = new ArrayList<>();
    ...
    public static GsmFragment1 newInstance(Long ip) {
        GsmFragment1 fragment = new GsmFragment1();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.gsm_fragment1, container, false);
        init(view);
        return view;
    }
    ...
    private void init(View view) {
        ...
        LETLog.d("get gsmConfig :" + gsmConfig.toString());
...
//        spinner_gsm_bts1_workmode = (MaterialSpinner) view.findViewById(R.id.spinner_gsm_bts1_workmode);
        spinner_gsm_bts2_workmode = (TextView) view.findViewById(R.id.spinner_gsm_bts2_workmode);
//        mGSMMncList1.add("移动");
//        mGSMMncList1.add("联通");
//        mGSMMncList1.add("电信");
...
//        gsmConfig.Enable2 = (raGroup2GSM.getCheckedRadioButtonId() == R.id.rb_bts2_enable_enable_gsm) ? "1" : "0";
        ...
        LETLog.d("save gsmConfig :" + gsmConfig.CONFIGMODE2);
