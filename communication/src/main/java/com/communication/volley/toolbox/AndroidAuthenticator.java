 ...
 * tokens of BaseApplication specified type for BaseApplication specified account.
 */
public class AndroidAuthenticator implements Authenticator {
    ...
    /**
     * Creates BaseApplication new authenticator.
     ...
     * @param account Account to authenticate as
     * @param authTokenType Auth token type passed to AccountManager
     * @param notifyAuthFailure Whether to raise BaseApplication notification upon auth failure
     */
    public AndroidAuthenticator(Context context, Account account, String authTokenType,
    ...
    // Visible for testing. Allows injection of BaseApplication mock AccountManager.
